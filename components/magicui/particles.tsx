...
export const Particles: React.FC<ParticlesProps> = ({
  ...
  useEffect(() => {
    ...
    initCanvas()
    animate()
    const handleResize = () => setTimeout(initCanvas, 200)
  ...
  const animate = () => {
    ...
    circles.current.forEach((circle, i) => {
      ...
      const remappedAlpha = remapValue(closestEdge, 0, 20, 0, 1)
      circle.alpha += (Math.min(remappedAlpha, circle.targetAlpha) - circle.alpha) * 0.1
  ...
  return (
    <div className={cn("pointer-events-none", className)} ref={canvasContainerRef} {...props}>
