...
export async function POST(req: Request) {
  ...
  try {
    ...
    await resend.emails.send({
      from: 'John @ Tech Culture Club <hello@vector.ag>',
      to: email,
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px; color: #171717;">
          ...
          <p style="color: #525252; line-height: 1.6; margin-bottom: 16px;">
            Every week, I'll break down how AI is reshaping museums, galleries, and luxury brands — with case studies, frameworks, and things you can actually use.
          </p>
